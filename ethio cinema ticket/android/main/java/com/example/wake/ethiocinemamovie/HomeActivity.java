...
import com.example.wake.ethiocinemamovie.Adapters.SlideShowAdapter;
...
public class HomeActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pager = findViewById(R.id.homeSlideWrapper);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        else if (id == R.id.yourTickets) {
            startActivity(
                    new Intent(this, TicketsActivity.class)
            );
        }
